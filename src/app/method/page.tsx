    ...
    <article className="space-y-10">
      ...
      <Section title="하는 일">
        <p>
          ...
          제목을 달았는지</em>{" "}원문 그대로 모아 나란히 놓습니다. 언론 기사와 유튜브
          영상은 같은 프레임 안에서도 따로 표시합니다. 제목은 요약하거나 바꿔 쓰지 않고,
          모든 항목에 원문 링크를 겁니다.
        </p>
      </Section>
      ...
      <Section title="프레임은 어떻게 나누나">
        <p>
          사건마다 기사·영상의 제목을 읽고 2~4개로 묶습니다. 자동 작업은 구조 검사를
          통과한 결과만 승인 대기열에 넣고, 사람의 병합·승인 뒤에만 게시합니다.
        </p>
        <ul className="list-disc space-y-2 pl-5">
      ...
      <Section title="&lsquo;보도하지 않음&rsquo;은 무슨 뜻인가">
        ...
        <p>
          <strong className="font-semibold">이 판정은 검색어에 달려 있습니다.</strong>{" "}
          한 사건에서 검색어를 「보완수사권 폐지 당론 채택」에서 「보완수사권 폐지
          형사소송법 개정안 당론」으로 바꾸자, 같은 시간대인데도 &lsquo;보도하지
          않음&rsquo;이 6곳에서 0곳으로 바뀌었습니다. 실제로 보도한 매체가 검색어에
          걸리지 않아 미보도로 찍힐 수 있다는 뜻입니다. 그래서 사건 페이지마다
          사용한 검색어를 그대로 적습니다.
        </p>
      ...
      <Section title="한계">
        <ul className="list-disc space-y-2 pl-5">
          <li>제목만 봅니다. 영상의 발언·자막·썸네일 또는 기사 본문의 논조는 아직 분석하지 않습니다</li>
